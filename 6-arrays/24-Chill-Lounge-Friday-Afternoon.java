...
import java.util.Arrays; // we will use this so we can access the tools in Array class in this way we did use Arrays.sort and Arrays.equals
...
public class HelloWorld {
  ...
  public static void main(String[] args) {
    ...
    // Array playlistOne
    int[] playlistOne = {10070, 10060, 10050, 2015, 2016, 2019, 20042, 20017, 19004, 4244, 6192, 10030, 2001, 2949, 23456}; // 15 index numbers

    // Array playlistTwo
    int[] playlistTwo = {10069, 10059, 10049, 2014, 20015, 2018, 20043, 20018, 19005, 4245, 6193, 10029, 2000, 2950, 23457}; // 15 index numbers
